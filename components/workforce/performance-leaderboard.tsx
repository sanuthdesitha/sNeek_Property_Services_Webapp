...
import { PerformanceLeaderboardChart } from "@/app/admin/workforce/performance/performance-leaderboard-chart";
...
/**
 * Server-rendered cleaner performance leaderboard. Extracted from the old
 * /admin/workforce/performance page so it can be reused as the "Performance"
 * tab of the unified Workforce hub. All data/auth/logic preserved verbatim —
 * the caller is responsible for the role gate (ADMIN / OPS_MANAGER /
 * QA_INSPECTOR), matching the original page.
 */
  ...
  return (
    <div className="space-y-6">
      <p className="text-sm text-muted-foreground">
        ...
        {cleaners.length === 1 ? "" : "s"}. Click a row for the full breakdown.
      </p>
