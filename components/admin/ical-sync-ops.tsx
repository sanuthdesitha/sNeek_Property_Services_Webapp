...
/**
 * iCal sync operations console. Lifted out of the old /admin/integrations page
 * so it can live as the "iCal Sync" section of admin Settings. All data /
 * fetch / bulk-resync logic preserved verbatim; only the surrounding PageHeader
 * was replaced with an inline section header + Refresh button for embedding.
 */
export function IcalSyncOps() {
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
        <div>
          <h3 className="text-lg font-semibold">iCal Sync Ops</h3>
      ...
      <div className="grid gap-4 md:grid-cols-4">
        <Card>
          <CardContent className="pt-5">
            ...
            <p className="mt-2 text-2xl font-semibold tabular-nums">{payload.summary.totalRuns}</p>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="pt-5">
            <p className="text-xs uppercase tracking-[0.18em] text-muted-foreground">Properties</p>
            <p className="mt-2 text-2xl font-semibold tabular-nums">{payload.summary.totalProperties}</p>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="pt-5">
            <p className="text-xs uppercase tracking-[0.18em] text-muted-foreground">Syncable</p>
            <p className="mt-2 text-2xl font-semibold tabular-nums">{payload.summary.syncableProperties}</p>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="pt-5">
            <p className="text-xs uppercase tracking-[0.18em] text-muted-foreground">Errors</p>
            <p className="mt-2 text-2xl font-semibold tabular-nums">{payload.summary.statusCounts.ERROR ?? 0}</p>
          </CardContent>
        </Card>
      </div>
