...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent
    ref={ref}
    className={cn(
      "z-50 min-w-[8rem] overflow-hidden rounded-xl border border-input/80 bg-popover/95 p-1 text-popover-foreground shadow-[0_14px_32px_-20px_rgba(20,64,70,0.7)] backdrop-blur-sm",
      className
    )}
    {...props}
  />
