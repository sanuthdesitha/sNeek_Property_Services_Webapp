  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-text-secondary mt-1">Your cleaning schedule at a glance</p>
      </div>
      ...
      <Card variant="outlined">
        ...
        <CardContent>
          <div className="space-y-4">
            {[
              { date: "Apr 16", jobs: [{ time: "10:00 AM", property: "Harbour View Apt", type: "Airbnb Turnover" }] },
              { date: "Apr 18", jobs: [{ time: "2:00 PM", property: "Beach House", type: "Deep Clean" }] },
              { date: "Apr 21", jobs: [{ time: "9:00 AM", property: "Harbour View Apt", type: "General Clean" }] },
            ].map((day) => (
