  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-text-secondary mt-1">Chat with your team and admin</p>
      </div>

      <Card variant="outlined">
        <CardContent className="pt-4">
          <Input placeholder="Search messages..." leftIcon={<Search className="h-4 w-4" />} className="mb-4" />
