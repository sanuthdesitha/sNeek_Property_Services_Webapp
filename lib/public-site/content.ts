...
export const DEFAULT_WEBSITE_CONTENT: WebsiteContent = {
  ...
  faq: {
    ...
    items: [
      ...
      { id: "faq-4", category: "pricing", question: "How is pricing calculated?", answer: "Pricing is based on property size (bedrooms/bathrooms), condition level, add-ons selected (oven, fridge, balcony, etc.), and service type. Our quote tool gives you an instant itemised breakdown and clearly shows whether GST is applied." },
      { id: "faq-5", category: "pricing", question: "Are there any hidden fees?", answer: "No hidden fees. The quote you receive shows a clear line item breakdown and whether GST is applied. If the scope changes on the day (e.g. property is in worse condition than described), we'll discuss it with you before continuing." },
