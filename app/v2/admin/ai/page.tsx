...
export default async function AiConfigurationPage() {
  ...
  return <div className="space-y-6">
    ...
    <dl className="grid gap-x-8 gap-y-5 sm:grid-cols-2">
      ...
      <div><dt className="text-sm text-[hsl(var(--e-muted-foreground))]">Server credential</dt><dd className="mt-1 text-sm font-medium">{config.configured ? "Present" : "Missing"}</dd></div>
