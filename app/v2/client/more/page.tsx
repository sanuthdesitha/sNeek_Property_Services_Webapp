...
import { ChevronRight, FileText, Gift, LifeBuoy, Settings, User } from "lucide-react";

export const metadata = { title: "More · Estate client" };

const ITEMS = [
  { href: "/v2/client", label: "Report archive", desc: "Every clean, documented", icon: FileText },
  { href: "/v2/client", label: "Rewards & referrals", desc: "Earn credit for referrals", icon: Gift },
  { href: "/v2/client", label: "Cases & disputes", desc: "Raise or track an issue", icon: LifeBuoy },
  { href: "/v2/client", label: "Profile", desc: "Your details", icon: User },
  { href: "/v2/client", label: "Settings", desc: "Notifications & preferences", icon: Settings },
];
