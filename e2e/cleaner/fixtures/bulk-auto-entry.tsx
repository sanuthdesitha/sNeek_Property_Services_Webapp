...
function Fixture() {
  const [pool, setPool] = React.useState<CapturedMedia[]>(location.search.includes("legacy") ? [{ key: "forms/cleaner/old.jpg", url: "/old.jpg", kind: "image", name: "Old photo" }] : []), [uploads, setUploads] = React.useState<UploadMap>({});
